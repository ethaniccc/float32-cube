...
// axes.
func (p Pos) Vec3Middle() mgl32.Vec3 {
...
func (p Pos) Vec3Centre() mgl32.Vec3 {
...
func PosFromVec3(vec3 mgl32.Vec3) Pos {
	return Pos{int(math32.Floor(vec3[0])), int(math32.Floor(vec3[1])), int(math32.Floor(vec3[2]))}
}
