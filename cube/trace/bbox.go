...
func BBoxIntercept(bb cube.BBox, start, end mgl32.Vec3) (result BBoxResult, ok bool) {
	...
	var (
		vec  *mgl32.Vec3
		dist = float32(math.MaxFloat32 - 1)
	)

	for _, v := range [...]*mgl32.Vec3{v1, v2, v3, v4, v5, v6} {
		if v == nil {
			continue
		}
...
// vec3OnLineWithX returns an mgl32.Vec3 on the line between mgl32.Vec3 a and b with an X value passed. If no such vec3
...
// vec3OnLineWithY returns an mgl32.Vec3 on the line between mgl32.Vec3 a and b with a Y value passed. If no such vec3
// could be found, the bool returned is false.
...
// vec3OnLineWithZ returns an mgl32.Vec3 on the line between mgl32.Vec3 a and b with a Z value passed. If no such vec3
// could be found, the bool returned is false.
