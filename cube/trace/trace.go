...
func TraverseBlocks(start, end mgl32.Vec3, f func(pos cube.Pos) (con bool)) {
	dir := end.Sub(start)
	if mgl32.FloatEqual(dir.LenSqr(), 0) {
...
// safeDivideVec3 ...
func safeDivideVec3(dividend, divisor mgl32.Vec3) mgl32.Vec3 {
	return mgl32.Vec3{
...
func safeDivide(dividend, divisor float32) float32 {
	if divisor == 0.0 {
		return 0.0
	}
...
// boundaryVec3 ...
func boundaryVec3(v1, v2 mgl32.Vec3) mgl32.Vec3 {
	return mgl32.Vec3{boundary(v1[0], v2[0]), boundary(v1[1], v2[1]), boundary(v1[2], v2[2])}
}
...
func boundary(start, dir float32) float32 {
	if dir == 0.0 {
		return math32.Inf(1)
	}
	...
	if dir < 0.0 {
		start, dir = -start, -dir
		if math32.Floor(start) == start {
			return 0.0
		}
	}

	return (1 - (start - math32.Floor(start))) / dir
}

// signVec3 ...
func signVec3(v1 mgl32.Vec3) mgl32.Vec3 {
	return mgl32.Vec3{sign(v1[0]), sign(v1[1]), sign(v1[2])}
}
